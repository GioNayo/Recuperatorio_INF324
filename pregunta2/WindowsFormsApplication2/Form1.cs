...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var radio = Math.Max((double)500/bmp.Width ,(double)500/bmp.Height);
            var nuevoancho = (int)(bmp.Width * radio);
            var nuevoalto = (int)(bmp.Height * radio);
            var imagennueva = new Bitmap(nuevoancho, nuevoalto);
            Graphics.FromImage(imagennueva).DrawImage(bmp, 0, 0, nuevoancho, nuevoalto);
            bmp3 = new Bitmap(imagennueva);
